(function(){
   ...
   Chess.prototype._initialiseEvents = function(){
      ...
      this.engine.subscribe(C.Engine.MOVELOG_PROCESSED, this.UI.handlePgnLogProcesed, this.UI);
   };

   C.Chess = new Chess();
   C.Chess.engine.processMoveLog(["1. Pd2-d4 Pc7-c5", "2. Pe2-e3 Kb8-a6", "3. Qd1-g4"]);
